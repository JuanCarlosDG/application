...
if ($this->module_lib->hasActive('academics')) {
    if (($this->rbac->hasPrivilege('class_timetable', 'can_view') ||
         $this->rbac->hasPrivilege('salon', 'can_view') ||
      ...
      if ($this->rbac->hasPrivilege('teachers_time_table', 'can_view')) {
            ?>
                                <li class="<?php echo set_Submenu('Academics/timetable/mytimetable'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/mytimetable"><i class="fa fa-angle-double-right"></i> <?php echo "Horario de ".$this->lang->line('teachers') . " " ?></a></li>
                                <?php
}
        ...
        if ($this->rbac->hasPrivilege('subject_group', 'can_view')) {
            ?>
                                <li class="<?php echo set_Submenu('subjectgroup/index'); ?>"><a href="<?php echo base_url('admin/subjectgroup'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('') . "Asignar materias a grupo" . $this->lang->line('') ?></a></li>
                                <?php
}
...
//nueva seccion  salones

   if ($this->rbac->hasPrivilege('salones', 'can_view')) {
            ?>
                                <li class="<?php echo set_Submenu('Academics/timetable/salones'); ?>"><a href="<?php echo base_url(); ?>admin/timetable/salones"><i class="fa fa-angle-double-right"></i> <?php echo "Salones" ?></a></li>
